...
export function QuotationForm({ clients, services }: Props) {
  ...
  return (
    <>
      ...
      <h1 className="mt-4 text-3xl font-semibold tracking-[-0.035em]">New Quotation</h1>

      <form action={createQuotationAction} className="mt-8 space-y-6">
